...
namespace Eshop.EshopSendSms {
    ...
    public partial class SendReceive : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SendReceive() {
            this.Url = global::Eshop.Properties.Settings.Default.Eshop_EshopSendSms_SendReceive;
        ...
        /// <remarks/>
        public void SendSingleMessageAsync(string userName, string password, string messageText, string mobile, string lineNumber, string message) {
            this.SendSingleMessageAsync(userName, password, messageText, mobile, lineNumber, message, null);
        }
        
        /// <remarks/>
        public void SendSingleMessageAsync(string userName, string password, string messageText, string mobile, string lineNumber, string message, object userState) {
            ...
            this.InvokeAsync("SendSingleMessage", new object[] {
                        ...
                        mobile,
                        lineNumber,
                        message}, this.SendSingleMessageOperationCompleted, userState);
        }
